...
class CreateChallengeCustom extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
      ...
      if (!this.state.challengeCreated) {
        return (
          <div className="spinnerContainerChallenge">
            <span className="spinnerChallengeText">Creating challenge</span>
        ...
        return (
          <div className="spinnerContainerChallenge">
            <span className="spinnerChallengeText">Challenge created successfully!</span>
          </div>
        )
      }
    } else {
...
export default withRouter(CreateChallengeCustom);